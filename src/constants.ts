...
export const MANUAL_XLSX_STRATEGY_DESCRIPTION = "В стратегии «Загрузить вручную» вы выбираете кластеры и товары, скачиваете XLSX-шаблон, заполняете в нём количества к поставке и затем загружаете файл обратно. Файл должен содержать столбцы: Артикул, <имя кластера 1>, <имя кластера 2>, ... (имена кластеров должны совпадать с Ozon). Пустые ячейки считаются как 0.";
